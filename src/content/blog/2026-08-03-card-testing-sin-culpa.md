...
description: "Un cargo mínimo en una tarjeta jamás usada revela cómo se generan y validan los números que la identifican antes de usarla para robar."
pubDate: 2026-08-03
...
<p class="pie-foto">Foto: <a href="https://commons.wikimedia.org/wiki/User:Lotus_Head">Lotus Head</a>, Wikimedia Commons (<a href="https://creativecommons.org/licenses/by-sa/2.5">CC BY-SA 2.5</a>), recortada y convertida a WebP. <a href="https://commons.wikimedia.org/w/index.php?title=File:Credit-cards_(cropped).jpg&oldid=1022568425">Original</a>.</p>
...
El cargo procedía de una tienda electrónica donde esa tarjeta no figuraba entre mis métodos de pago guardados, como se deduce del párrafo anterior.
...
Los primeros seis a ocho dígitos de cualquier tarjeta son información pública. Es el BIN (Bank Identification Number), el número de identificación del banco (emisor). El atacante genera el resto del número. El algoritmo que rige la estructura de los números de tarjeta, el [algoritmo de Luhn](https://es.wikipedia.org/w/index.php?title=Algoritmo_de_Luhn&oldid=169437299), permite descartar la mayoría de combinaciones inválidas antes de probarlas, lo que reduce considerablemente la búsqueda. Lo mismo ocurre con la fecha de caducidad y el CVV. Así que, con fuerza bruta, y muchas pruebas, los ladrones lo consiguen (Eaton & Vinson, 2025) y (Banco de España, 2023).

Antes de intentar una compra grande con una tarjeta que se usará fraudulentamente, los delincuentes suelen probarla primero. La práctica se llama *card testing*. Consiste en lanzar cargos mínimos, muchas veces por debajo de un euro, en comercios *online* de facturación rápida. Los importes se mantienen bajos a propósito para que el titular no los note ni los denuncie. De esa manera, el ladrón gana tiempo. Si el cargo pasa, el atacante sabe que el número de tarjeta está activo y es válido (Emewulu, 2026) y (Palmer, 2025). 

Hay un caso ampliamente documentado. Tesco Bank, una entidad británica, sufrió entre 2015 y 2016 una oleada de intentos automatizados que llevó a la sustracción de 22 millones de libras de 20 000 tarjetas, y obligó a suspender los pagos con tarjeta durante 48 horas (Puzin, 2025).

## Sin la más mínima negligencia por parte del cliente

Nada de esto depende de que el titular haya hecho algo mal, Lotrives en este caso. No ha pinchado en un enlace de *phishing* (mensaje electrónico fraudulento), ni usado una contraseña débil, ni comprado en una web insegura. 

El ataque no se dirige contra la persona: se dirige contra el propio sistema de validación de pagos.

## Conclusión

El BIN está muy mal hecho y los emisores tendrían que tomar nota.
